...
อย่าลืมเขียนโปรแกรมในส่วนการทดลองใช้งานด้วย 3 ลูกค้า
"""
...
print(create_user_profile("phoorinat",19 ))
print(create_user_profile("ratchatawit"))
print(create_user_profile("peter parker", 26 ,True))
